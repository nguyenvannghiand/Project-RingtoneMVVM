...
class BasketAdapter : androidx.recyclerview.widget.RecyclerView.Adapter<BasketAdapter.ViewHolder>() {
    ...
    class ViewHolder(binding: ItemBasketBinding, adapter: BasketAdapter) : androidx.recyclerview.widget.RecyclerView.ViewHolder(binding.root) {
